...
export const StadiumMap: React.FC = () => {
  ...
  const getGateColorClass = (occupancy: number) => {
    if (occupancy >= 90)
      return "fill-red-500 stroke-red-600 gate-critical-pulse";
    if (occupancy >= 75)
      return "fill-amber-500 stroke-amber-600 gate-warning-pulse";
            ...
            {viewMode === "2D" ? (
              ...
              >
                    ...
                    <g>
                      <circle r="1.2" fill="#ef4444">
                        <animateMotion
                          dur="5s"
                          repeatCount="indefinite"
                          path="M 700 210 Q 550 350 400 350"
                        />
                      </circle>
                      <circle r="1.2" fill="#ef4444">
                        <animateMotion
                      ...
                      <circle r="1.2" fill="#ef4444">
                        <animateMotion
                          dur="5.8s"
                          repeatCount="indefinite"
                          path="M 700 210 Q 400 120 100 210"
                        />
                      </circle>
                      <circle r="1.2" fill="#ef4444">
                        <animateMotion
                  ...
                  {isStorm && (
                    <g>
                      <text
                        x="200"
                        y="50"
                        className="text-xl opacity-75 animate-bounce"
                      >
                        ⚡
                      </text>
                      <text
                  ...
                  {showResources &&
                    (stadiumState as any)?.assets?.map((asset: any) => (
                      <g key={asset.id} className="transition-all duration-300">
                        ...
                        <g
                          transform={`translate(${asset.x - 35}, ${asset.y - 28})`}
                        >
                          <rect
                            rx={4}
                            width={70}
                ...
                <div className="w-full grid grid-cols-4 sm:grid-cols-7 gap-2 bg-slate-950/40 border border-white/5 p-3 rounded-xl text-[9px] font-semibold text-gray-400 mt-4 select-none">
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-emerald-400 font-bold">➔</span> AI
                    Detour
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-amber-500 font-bold">⇢</span> Predict
                    Spill
                  </div>
                  <div className="flex items-center gap-1">
